...
function map_init() {
    ...
    var point = new BMap.Point(112.985932, 28.186347); //地图中心点
    ...
    for (var i = 0; i < markerArr.length; i++) {
        var myIcon = new BMap.Icon('../HYJL_Web/images/base/address.png', new BMap.Size(18, 31));//这里先不用第三个参数IconOptions
